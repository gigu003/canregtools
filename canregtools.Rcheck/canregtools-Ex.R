...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: as_canreg
### Title: Construct a canreg object
### Aliases: as_canreg

### ** Examples

## Not run: 
##D # Using raw registry data
##D canreg_obj <- as_canreg(
##D   regi_data = my_registry_df,
##D   population = my_population_df,
##D   year = 2023,
##D   areacode = "410100"
##D )
##D 
##D # Using separate incidence and mortality data frames
##D canreg_obj <- as_canreg(
##D   incidence = my_incidence_df,
##D   mortality = my_mortality_df,
##D   population = my_population_df
##D )
## End(Not run)
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("as_canreg", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("calc_age")
### * calc_age
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("calc_ax", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("canregs")
### * canregs
...
classify_areacode2(c("110000", "320500", "440300"))
...
###   cr_merge.qualities cr_merge.age_rates cr_merge.site_morps
###   cr_merge.checks cr_merge.summaries
...
cleanEx()
nameEx("create_canreg_report_data")
### * create_canreg_report_data

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: create_canreg_report_data
### Title: Create a standardized cancer registry report data object
### Aliases: create_canreg_report_data

### ** Examples

## Not run: 
##D data("canregs")
##D report_data <- create_canreg_report_data(canregs, year = 2022)
##D summary(report_data)
## End(Not run)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("create_canreg_report_data", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
...
cleanEx()
nameEx("create_site_morp")
### * create_site_morp

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: create_site_morp
### Title: Count ICD-10 site and morphology groups by strata
### Aliases: create_site_morp create_site_morp.canreg
###   create_site_morp.canregs create_site_morp.fbswicds
...
##D data("canregs")
##D 
##D create_site_morp(canregs, year, sex, cancer)
##D create_site_morp(canregs, year, sex, cancer, type = "morp")
##D create_site_morp(canregs, year, sex, cancer, type = "both")
##D create_site_morp(canregs, year, sex, cancer, collapse = FALSE)
##D 
##D fbsw <- count_canreg(canregs[[1]])
##D create_site_morp(fbsw, year, sex, cancer, flatten = FALSE)
## End(Not run)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("create_site_morp", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("cumrate")
### * cumrate
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("expand_lx", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("get_stdpop")
### * get_stdpop
