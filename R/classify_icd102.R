#' CConvert ICD10 Codes to Cancer Categories.
#' 
#' @description
...
#' @param cancer_type Character, type of cancer category ("system","big","small","gco"),
...
classify_icd102 <- function(x, cancer_type = "big", as_factor = FALSE) {
