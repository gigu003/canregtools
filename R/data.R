...
#'
#' @docType data
#' @format A data frame with quality indicators for various cancer types across different years and area types.
#' \describe{
...
#'
#' This dataset provides example data from population-based cancer registries (PBCRs),
#' structured using the `canregs` class. It can be used for demonstration, testing,
#' or development purposes within the `canregtools` package.
#'
#' @docType data
